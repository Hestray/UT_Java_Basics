...
public class AquariumController {
    ...
    private pHmonitor pHsensor           = new pHmonitor();
    ...
    public void modifyPH(float pH) {
        if (pH > 6.3f && pH < 7.8) {
            this.pHsensor.setValue(pH);
            System.out.println(this.pHsensor.toString());
        }
        else
        {
            this.alarm.turnOn();
            System.out.println(this.alarm.toString());
        }
    }
    @Override
    ...
    public void setpHsensor(pHmonitor pHsensor) {
