...
public class VendingMachine {
    ...
    public VendingMachine(String prodName, int cost) {
        number++;
    ...
    public VendingMachine(String[] prodList, int[] cost, String command) {
        ...
        switch(choice) {
            ...
            case 2:
                ...
                else
                {
                    ...
                    this.profit = this.profit - prices.get(ID);
                }
    ...
    public static void main(String[] args) {
        ...
        int[]       prices      = {7, 5, 2};
        VendingMachine prod = new VendingMachine(prodList, prices, "R");
